...
<div id="wrapper">
    ...
    <h1><a href="index.php"><img src="xres/images/logo.png" class="logo" alt="James Buchanan Pub and Restaurant" /></a></h1>
        <ul id="mainnav">
			...
			<li class="current"><a href="gallery.php">BỘ SƯU TẬP</a></li>
    ...
    <div id="content">
    	<div id="gallerycontainer">
			<ul class="portfolio-categ filter">
				...
				<li class="cat-item-1"><a href="#" title="Category 1">Loại 1</a></li>
				<li class="cat-item-2"><a href="#" title="Category 2">Loại 2</a></li>
				<li class="cat-item-3"><a href="#" title="Category 3">Loại 3</a></li>
				<li class="cat-item-4"><a href="#" title="Category 4">Loại 4</a></li>
			</ul>
			<ul class="portfolio-area">	
                   ...
                   <div class="home-portfolio-text">
                    ...
                    <p class="post-subtitle-portfolio">Ngày sản xuất: 2008</p>
					</div>
                   ...
                   <div class="home-portfolio-text">
                    ...
                    <p class="post-subtitle-portfolio">Ngày sản xuất: 2009</p>
					</div>
                   ...
                   <div class="home-portfolio-text">
                    ...
                    <p class="post-subtitle-portfolio">Ngày sản xuất: 2011</p>
					</div>
                   ...
                   <div class="home-portfolio-text">
                    ...
                    <p class="post-subtitle-portfolio">Ngày sản xuất: 2010</p>
					</div>
                   ...
                   <div class="home-portfolio-text">
                    ...
                    <p class="post-subtitle-portfolio">Ngày sản xuất: 2003</p>
					</div>
                   ...
                   <div class="home-portfolio-text">
                    ...
                    <p class="post-subtitle-portfolio">Ngày sản xuất: 2012</p>
					</div>
