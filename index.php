...
<!--sa calendar-->	
		...
		*/
		...
		{
		var x=document.forms["addcalendar"]["start"].value;
		if (x==null || x=="")
		  {
		  alert("Bạn phải chọn ngày đặt phòng(click the calendar icon)");
		  return false;
		  }
		var y=document.forms["addcalendar"]["end"].value;
		if (y==null || y=="")
		  {
		  alert("Bạn phải chọn ngày trả phòng(click the calendar icon)");
		  return false;
		  }
		}
		</script>
...
<div id="wrapper">
    	...
    	<div id="rotator">
			  ...
			  <div id="logo" style="left: 600px; height: auto; top: 23px; width: 260px; position: absolute; z-index:4;">
					...
					<div class="accordion-content" style="margin-bottom: 15px;">
						<form action="reservation/demo.php" method="post" style="padding-top: 4px" name = "addcalendar"  onsubmit="return validateForm()">
						<span style="margin-right: 11px;">Ngày Đặt Phòng: <input type="text" class="w8em format-d-m-y highlight-days-67 range-low-today" name="start" id="sd" value="" maxlength="10" readonly="readonly" style="width: 165px; margin-left: 15px; border: 3px double #CCCCCC; padding:5px 10px;"/></span><br>
						<span style="margin-right: 11px;">Ngày Trả Phòng:<input type="text" class="w8em format-d-m-y highlight-days-67 range-low-today" name="end" id="ed" value="" maxlength="10" readonly="readonly" style="width: 165px; margin-left: 15px; border: 3px double #CCCCCC; padding:5px 10px;" /></span><br>
						<input type="hidden" name="result" id="result" /><br>
						<span><input type="submit" onclick="setDifference(this.form);" value="TÌM KIẾM" style="height: 34px; margin-left: 15px; width: 191px; padding: 5px; border: 3px double rgb(204, 204, 204);" /></span>
					...
					<h2 class="accordion-header" style="height: 18px; margin-bottom: 15px; color: rgb(255, 255, 255); background: none repeat scroll 0px 0px rgb(53, 48, 48);">Hủy Đặt Phòng</h2>
					<div class="accordion-content" style="margin-bottom: 15px;">
						<form action="cancelexec.php" method="post" style="margin-bottom:none;">
						<span style="margin-right: 11px;">Mã đặt: <input type="text" name="confirmation" style="width: 165px; margin-left: 15px; border: 3px double #CCCCCC; padding:5px 10px;"/></span><br><br>
						<input type="submit" id="submit" class="medium gray button" value="Hủy đặt" style="height: 34px; margin-left: 15px; width: 191px; padding: 5px; border: 3px double rgb(204, 204, 204);" />
						</form>
					</div>
				</div>
        </div>
    ...
    <div id="featured">
        <div id="items">
            ...
            <h3><a href="main-course.php">Sự kiện đặt biệt</a></h3>
            <p><a href="main-course.php"><strong>Món Ăn Đặc Trừng</strong><br />
			Hãy Đến Và Trải Nghiệm Nó<br /> Món Heo Quay Lạng Sơn
			<br /> Vào Ngày Đặc Biệt Hôm Nay!</a></p>  
            </div>
            <div class="item"> <a href="lodging.php"><img src="xres/images/02_featured.jpg" alt="" /></a>
            <h3><a href="lodging.php">Phòng Nghỉ Luôn Sẵn Có</a></h3>
            <p><a href="lodging.php"><strong>Khách Sạn Mường Thanh</strong><br />
			Được Xây Dựng Từ 1993 </a></p>  
			</div>
        </div>
