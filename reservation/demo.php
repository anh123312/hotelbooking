	...
	<div style="width:1000px; height:auto;">
		<div class="container" style="float: left; width: 464px;">
			...
			<span class="top-label">
				<span class="label-txt">Danh Sách Phòng</span>
			</span>
			...
			<div class="content-area" style="border-radius:15px;">
				...
				<div class="content drag-desired">
					...
					{
					$a=$row['id'];
					  $query = mysqli_query($link,"SELECT sum(qty) FROM rooinventory where arrival <= '$arival' and departure >= '$departure' and room='$a'");
		...
		<div class="container" style="float: left; width: 299px; margin-left: 12px;">
			...
			<span class="top-label">
				<span class="label-txt">Thông Tin Phòng</span>
			</span>
		...
		<div class="container" style="float: right; width: 212px; padding-bottom: 15px;">
			<span class="top-label">
				<span class="label-txt">Thông Tin Của Bạn</span>
			</span>
			<div class="content-area" style="border-radius:15px; padding-bottom: 25px;">
				<div>
					...
					<input type="submit" onclick="document.forms.checkoutForm.submit(); return false;" class="button" value="Đặt Phòng" id="boxy"  style="width: 147px; margin-top: 18px;">
				</div>
			</div>
		</div>
		</form>
